            ...
            'headings' => array(
                array(
                    ...
                    'options' => array(
                        ...
                        array(
                            'name' => 'Hide Caption',
                            'desc' => 'Select Yes if you want to hide the Caption between the slides animation',
                            'id' => 'slider_hideCaption',
                            'value' => 'false',
                            'type' => 'checkbox',
                            'required' => TRUE
                        ),
                        array(
                            'name' => 'Hide Speed',
                            'desc' => 'Set the Caption hide speed (between 1%-100%)',
                            'id' => 'slider_hideSpeed',
                            'value' => '58',
                            'type' => 'text',
                            'required' => TRUE
            ...
            'headings' => array(
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => 'Image <br />(645px × 407px)',
