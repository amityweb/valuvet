...
register_taxonomy($post_type . '_rooms', array($post_type), array(
    'hierarchical'  => true,
    'labels'        => array(
        'name'                      => __('Practice types','tfuse'),
        'singular_name'             => __('Practice type','tfuse'),
        'search_items'              => __('Search Practice types','tfuse'),
        'all_items'                 => __('All Practice types','tfuse'),
        'parent_item'               => __('Parent Practice type','tfuse'),
        'parent_item_colon'         => __('Parent Practice type:','tfuse'),
        'edit_item'                 => __('Edit Practice type','tfuse'),
        'update_item'               => __('Update Practice type','tfuse'),
        'add_new_item'              => __('Add New Practice type','tfuse'),
        'new_item_name'             => __('New Practice type Name','tfuse'),
