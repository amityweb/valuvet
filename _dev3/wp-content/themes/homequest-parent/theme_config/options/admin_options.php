                ...
                array(
                    ...
                    'options' => array(
                        ...
                        array('name' => 'Custom Copyright',
                            ...
                            'value' => 'Made by <a href="http://themefuse.com">Themefuse.com</a>',
                            'type' =>'textarea'
                        )
                    )
                ),
            ...
            'headings' => array(
                array(
                    ...
                    'options' => array(
                        ...
                        array(
                            ...
                            'desc' => 'Pick one or more categories by starting to type the category name.',
                ...
                array(
                    ...
                    'options' => array(
                        array(
                            'name' => 'Template',
                            'desc' => 'Select the template',
                            'id' => TF_THEME_PREFIX . '_template',
                            'value' => 'closed',
                            'options' =>  array('default' => 'Default', 'home' => 'Home'),
                            'type' => 'select'
                        ),
                        array('name' => 'Before content',
                            'desc' => 'Content to show above content and sidebar.',
                            'id' => TF_THEME_PREFIX . '_before_page_content',
                            'value' => '',
                            'type' => 'textarea',
                            'divider'   =>true
                        ),
                    ...
                    'options' => array(
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_select_search_slider_blog',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('slidesjs'),
                                'type' => 'select'
                            ) :
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_before_content_select_slider_blog',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('jcarousel'),
                                'type' => 'select'
                            ) :
                        ...
                        array(
                            'name' => 'Number of properties to show',
                            'desc' => '',
                            'id' => TF_THEME_PREFIX . '_properties_number_blog',
                            'value' => '8',
                            'type' => 'text'
                        )
                    )
                    ...
                    'options' => array(
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_select_search_slider_search',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('slidesjs'),
                                'type' => 'select'
                            ) :
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_before_content_select_slider_search',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('jcarousel'),
                                'type' => 'select'
                            ) :
                        ...
                        array(
                            'name' => 'Number of properties to show',
                            'desc' => '',
                            'id' => TF_THEME_PREFIX . '_properties_number_search',
                            'value' => '8',
                            'type' => 'text'
                        ),
                    )
                    ...
                    'options' => array(
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_select_search_slider_404',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('slidesjs'),
                                'type' => 'select'
                            ) :
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_before_content_select_slider_404',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('jcarousel'),
                                'type' => 'select'
                            ) :
                        ...
                        array(
                            'name' => 'Number of properties to show',
                            'desc' => '',
                            'id' => TF_THEME_PREFIX . '_properties_number_404',
                            'value' => '8',
                            'type' => 'text'
                        ),
                    )
                    ...
                    'options' => array(
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_select_search_slider_tag',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('slidesjs'),
                                'type' => 'select'
                            ) :
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_before_content_select_slider_tag',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('jcarousel'),
                                'type' => 'select'
                            ) :
                        ...
                        array(
                            'name' => 'Number of properties to show',
                            'desc' => '',
                            'id' => TF_THEME_PREFIX . '_properties_number_tag',
                            'value' => '8',
                            'type' => 'text'
                        ),
                    )
                    ...
                    'options' => array(
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_select_search_slider_author',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('slidesjs'),
                                'type' => 'select'
                            ) :
                        ...
                        $this->ext->slider->model->has_sliders() ?
                            array(
                                'name' => 'Slider',
                                'desc' => 'Select a slider for your post. The sliders are created on the <a href="' . admin_url( 'admin.php?page=tf_slider_list' ) . '" target="_blank">Sliders page</a>.',
                                'id' => TF_THEME_PREFIX . '_before_content_select_slider_author',
                                'value' => '',
                                'options' => $TFUSE->ext->slider->get_sliders_dropdown('jcarousel'),
                                'type' => 'select'
                            ) :
                        ...
                        array(
                            'name' => 'Map position',
                            'desc' => 'Choose your map location',
                            'id' => TF_THEME_PREFIX . '_page_map_author',
                            'value' => '',
                            'type' => 'maps'
                        ),
                        array(
                            'name' => 'Number of properties to show',
                            'desc' => '',
                            'id' => TF_THEME_PREFIX . '_properties_number_author',
                            'value' => '8',
                            'type' => 'text'
                        ),
                    )
