...
$options = array(
    array(
        'name' => 'Email',
        'desc' => 'This email will not be displayed on the website, but if you set the Contact the agent form to go to the agent, it will go to this email. <a href="' . admin_url( 'admin.php?page=themefuse' ) . '" target="_blank">Change settings now</a>.',
        'id' => TF_THEME_PREFIX . '_agent_email',
        'value' => '',
        'type' => 'text'
        ),
    // Element of Hedear
