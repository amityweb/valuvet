...
require_once WPE_Path . 'core/CallerService.php';
session_start();
...
if( !isset($token) ) {
		...
		/* The servername and serverport tells PayPal where the buyer
		   ...
		   */
		   ...
		   $cancelURL =urlencode( $_REQUEST['cancel_URL'] );
		   $_SESSION['OPID'] = urlencode( $_REQUEST['OPID'] );
		   $_SESSION['OPTYPE'] = urlencode( $_REQUEST['OPTYPE'] );
	 ...
	 /* Construct the parameter string that describes the PayPal payment
           ...
           $nvpstr="&L_NAME0=".$L_NAME0."&L_AMT0=".$L_AMT0."&L_QTY0=".$L_QTY0."&AMT=".(string)$amt."&ITEMAMT=".(string)$itemamt."&L_DESC0=".$L_DESC0."&ReturnUrl=".$returnURL."&CANCELURL=".$cancelURL ."&CURRENCYCODE=".$currencyCodeType."&PAYMENTACTION=".$paymentType;
...
//				$location = WPE_URL . "core/APIError.php";
