...
(function($) {
	...
	$pc.fn.extend({
		...
		createThumb: function(ele) {
			...
			//ele.parents('div:first').wrapInner("<a class='ciccio' href='"+self.attr('src')+"'/>");
			ele.parents('div:first').wrapInner("<a class='galpika' href='"+self.attr('src')+"'/>");
			self.hide();
			...
			$('<img />').bind('load',{data:data},function(){
				...
				if(data.order == that.options.startOn){
					...
					//self.addClass('ciccio');
					self.addClass('galpika');
		...
		imgClick: function(e,x) {
			...
			//self.active.addClass('ciccio');
			self.active.addClass('galpika');
