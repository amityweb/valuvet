 ...
 */
    function tfuse_add_css()
    {
        ...
        if(!empty($_GET['selected_style']))
        {
            $color_scheme = $_GET['selected_style'];
            setcookie("themefuse_demo_homequest_style", $color_scheme);
        }
        else
        {
            if(!empty($_COOKIE['themefuse_demo_homequest_style'])) $color_scheme = $_COOKIE['themefuse_demo_homequest_style'];
        }
 ...
 */
    function tfuse_add_js()
    {
        ...
        wp_register_script( 'modernizr', $template_directory.'/js/libs/modernizr-2.5.3.min.js');
        wp_enqueue_script( 'modernizr' );

        wp_register_script( 'respond', $template_directory.'/js/libs/respond.min.js');
        ...
        wp_register_script( 'general', tfuse_get_file_uri('/js/general.js'), array('jquery'), '2.2', false );
