...
{
    extract(shortcode_atts(array('type' => '1', 'class' => '', 'rem' => ''), $atts));
    if ($rem == '')
    {
    ...
    {
        return '<div class="col col_' . $type . ' ' . $class . '">' . do_shortcode($content) . '</div>';
    }
