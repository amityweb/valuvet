...
function tfuse_faq_question($atts, $content = null) {
    global $faq_question;
    $faq_question[] = '<div class="faq_question toggle"><span class="faq_q">'.__('Q:','tfuse').'</span><span class="faq_title">' . do_shortcode($content) . '</span><span class="ico"></span></div>';
}
...
function tfuse_faq_answer($atts, $content = null) {
    global $faq_answer;
    $faq_answer[] = '<div class="faq_answer toggle_content">' . do_shortcode($content) . '</div>';
}
