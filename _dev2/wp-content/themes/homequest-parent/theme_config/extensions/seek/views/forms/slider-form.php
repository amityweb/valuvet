...
?>
    ...
    <div class="row submitField">
        <input type="submit" value="<?php print( esc_attr( sprintf(__('FIND %s','tfuse'), mb_strtoupper(TF_SEEK_HELPER::get_option('seek_property_name_plural', 'PROPERTIES'), 'UTF-8') ) ) ); ?>" id="search_submit" class="btn_search">
    </div>
