...
class TF_SEEK_SQL_GENERATORS {
        ...
        do {
            ...
            if(@$settings['auto_options']){
                ...
                if(isset($template_vars['listen_checkbox_id'])){
                    ...
                    $_GET[ $listen_item['parameter_name'] ] = (TF_SEEK_HELPER::get_input_value($listen_item['parameter_name']) == $listen_item['settings']['max'] ? $listen_item['settings']['max'] : $listen_item['settings']['min']);
    ...
    public static function favorites($item_id, $parameter_name, $sql_options, $settings, $template_vars, $all_item_options){
        ...
        do{
            ...
            $cookieFavorites    = (!empty($_COOKIE['favorite_posts'])) ? $_COOKIE['favorite_posts'] : '';
