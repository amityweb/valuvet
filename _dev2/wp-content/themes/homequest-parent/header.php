			...
			<div class="container_12">
				...
				<div class="header_top">
					...
					<div class="header_phone">
                        <a href="<?php echo site_url('?s=~&tfseekfid=main_search&favorites'); ?>" id="my_saved_offers"><?php _e('MY SAVED OFFERS', 'tfuse'); ?> <em><?php if(!empty($_COOKIE['favorite_posts'])) echo sizeof(explode(',',$_COOKIE['favorite_posts'])); else echo '0'; ?></em></a>
