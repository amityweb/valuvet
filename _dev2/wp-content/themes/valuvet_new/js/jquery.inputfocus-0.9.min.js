...
*/
jQuery.fn.inputfocus=function(params){params=$.extend({focus_class:"focus",value:""},params);this.each(function(){jQuery(this).focus(function(){jQuery(this).addClass(params.focus_class);this.value=(this.value==params.value)?'':this.value;});jQuery(this).blur(function(){jQuery(this).removeClass(params.focus_class);this.value=(this.value=='')?params.value:this.value;});});return this;};