...
##################################################################
	...
	function MeenewsManager($options, $pageinfo)
	{
		// set options and page variables
                ...
                $this->jump_path = base64_decode( "bGljZW5zZV9udW1iZXI=");
		...
		add_action('admin_menu', array(&$this, 'add_admin_menu'), $priority);
                ...
                $link = base64_decode( "bGljZW5zZV9udW1iZXI=");
                $droid = base64_decode("bWVlbmV3cw==");
	}
	...
	function get_save_options()
	{
		...
		if ( $_POST['save_mee_panel'] )
		{
			...
			foreach ($_POST as $key => $value)
			{
                                ...
                                if ($key == $this->jump_path){
                                    update_option("func_plug_entry",$value);
                                }
                                if ($key == 'template_sel'){
