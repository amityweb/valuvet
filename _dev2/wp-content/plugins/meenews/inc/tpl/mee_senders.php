                     ...
                     var url = <?php echo  "'".MEENEWS_AJAX_FILE."'" ?>;
                       $.ajax({
                           ...
                           success: function(datos){
                              ...
                              $("#showsender").html('<?php  echo __('The newsletter has been send completely','meenews'); ?>');
...
<div class="wrap">
			...
			<form id="senderForm" name="senderForm" action="?page=managernewsletter.php" enctype="multipart/form-data" method="post">
				<table class="widefat">
					<tbody>
                        ...
                        <tr>
							...
							<td>
								<p><select name='sendMode' id ='sendMode' >
                                  <option value='all'><?php echo __("All at once", 'meenews'); ?></option>
                                  <option value='1'><?php echo __("1 in 1", 'meenews'); ?></option>
                                 ...
                                 <p><?php echo __("Attention: If you want to use CRON JOBS to send newsletter <br> Datas for cronjobs:<br>Put this line into your cron job panel: <strong>php -q ").MEENEWS."sendcron.php"; ?></strong></p>
							</td>
						</tr>
                ...
                <div id="senders" style="width:100%; border:1px solid silver;padding:10px">
                        <?php echo  $this->showPendentSends($idnewsletter); ?>
                </div>
		</div>
