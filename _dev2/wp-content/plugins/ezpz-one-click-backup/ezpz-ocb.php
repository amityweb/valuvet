...
$dataKey = get_option('ezpz_ocb_backup_folder_name');
...
function ezpz_ocb_run_cron() {
	...
	if($GLOBALS['ezpz_ocb_cron_lock'] != 'on'){
	...
	if ($time > $next_backup) {
		...
		if (!file_exists(ezpz_ocb_backup_folder() . "/FILELOCK")) {
			...
			if (file_exists(EZPZOCB . "/backups/data/error-status.$dataKey.php")) {
				unlink(EZPZOCB . "/backups/data/error-status.$dataKey.php");
			}
			sleep(5); 
		...
		file_put_contents(EZPZOCB . "/backups/data/error-status.$dataKey.php", $message);
		$ezpz_ocb_cron_lock = 'off';
...
function clean_db_options() {
	global $wpdb;
	$needed_options = array('ezpz_ocb_available_extensions', 'ezpz_ocb_backup_count', 'ezpz_ocb_backup_cron_email', 'ezpz_ocb_backup_folder_name', 'ezpz_ocb_backup_in_progress', 'ezpz_ocb_backup_time', 'ezpz_ocb_backup_type', 'ezpz_ocb_cron_lock', 'ezpz_ocb_cron_time', 'ezpz_ocb_current_backup_time', 'ezpz_ocb_db_dump', 'ezpz_ocb_dropbox', 'ezpz_ocb_dropbox_args', 'ezpz_ocb_ds_format', 'ezpz_ocb_excluded_folders', 'ezpz_ocb_ftp', 'ezpz_ocb_last_backup_time', 'ezpz_ocb_last_log',  'ezpz_ocb_max_allowed', 'ezpz_ocb_options_array', 'ezpz_ocb_permissions', 'ezpz_ocb_prefix_only', 'ezpz_ocb_save_tz', 'ezpz_ocb_set_cron', 'ezpz_ocb_stylized', 'ezpz_ocb_release_num', 'ezpz_ocb_zip_date', 'ezpz_ocb_zip_name');
