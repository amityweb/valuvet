...
function tfuse_media($propertyID = null,$return=false)
{
    if ($propertyID) :
        ...
        $output .=  $image->width(218)->height(125)->src(tfuse_page_options('thumbnail_image', get_template_directory_uri() . '/images/dafault_image.jpg',$propertyID))->get_img();
    ...
    elseif (is_archive() || $is_tf_front_page)
    {
