...
function tfuse_chart($atts)
{
    ...
    if ($type == 'p3' || $type == 'p')
        return '<p><img class="noborder" src="http://chart.apis.google.com/chart?chxs=0,555555,11.5&chxt=x&chs=' . $width . 'x' . $height . '&cht=' . $type . '&#038;chtt=' . $title . '&#038;chl=' . $label . '&#038;chco=' . $colors . '&#038;chs=' . $width . 'x' . $height . '&#038;chd=t:' . $data . '&chdl=' . $legend . '&#038;chf=bg,s, ' . $colors . '" alt="' . $title . '"  /></p>';
    elseif ($type == 'lc')
        return '<p><img class="noborder" src="http://chart.apis.google.com/chart?cht=lc&amp;chtt=' . $title . '&amp;chl=' . $label . '&amp;chco=' . $colors . '&amp;chs=' . $width . 'x' . $height . '&amp;chd=t:'. $data .'&chdl=' . $legend . '" width="' . $width . '" height="' . $height . '" alt="' . $title . '" /></p>';
    elseif ($type == 'bvg')
        return '<p><img class="noborder" src="http://chart.apis.google.com/chart?cht=bvg&amp;chtt=' . $title . '&amp;chl=' . $label .'&amp;chco=' . $colors . '&amp;chs=' . $width . 'x' . $height . '&amp;chd=t:' . $data . '&amp;chf=bg,s,' . $colors . '" width="' . $width . '" height="' . $height . '" alt="' . $title . '" /></p>';
    else
        return '<p><img class="noborder" src="http://chart.apis.google.com/chart?chxs=0,555555,11.5&chxt=x&chs=' . $width . 'x' . $height . '&cht=' . $type . '&#038;chtt=' . $title . '&#038;chl=' . $label . '&#038;chco=' . $colors . '&#038;chs=' . $width . 'x' . $height . '&#038;chd=t:' . $data . '&chdl=' . $legend . '&#038;chf=bg,s, ' . $colors . '" alt="' . $title . '"  /></p>';
}
