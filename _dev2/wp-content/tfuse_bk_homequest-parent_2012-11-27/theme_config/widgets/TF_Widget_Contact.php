...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('adress'); ?>"><?php _e('Adress:'); ?></label><br/>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('extra1_title'); ?>"><?php _e('Extra 1 Title:'); ?></label><br/>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('extra1_content'); ?>"><?php _e('Extra 1 Content:'); ?></label><br/>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('extra2_title'); ?>"><?php _e('Extra 2 Title:'); ?></label><br/>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('extra2_content'); ?>"><?php _e('Extra 2 Content:'); ?></label><br/>
    ...
    <p>
        <label for="<?php echo $this->get_field_id('skype'); ?>"><?php _e('Skype ID:'); ?></label><br/>
