...
class TF_Widget_Text extends WP_Widget {
    ...
    <p><input id="<?php echo $this->get_field_id('rem_div'); ?>" name="<?php echo $this->get_field_name('rem_div'); ?>" type="checkbox" <?php checked(isset($instance['rem_div']) ? $instance['rem_div'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('rem_div'); ?>"><?php _e('Remove text div'); ?></label></p>
