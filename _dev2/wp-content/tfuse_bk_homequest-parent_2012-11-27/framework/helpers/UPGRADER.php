...
class TF_Theme_Upgrader extends Theme_Upgrader {
    ...
    function upgrade_strings() {
        ...
        $this->strings['skin_before_update_header'] = __('Updating %1$s (%2$d/%3$d)');
        $this->strings['up_to_date'] = __('The package is at the latest version.');
        $this->strings['remove_old'] = __('Removing the old version of the %s&#8230;');
        $this->strings['remove_old_failed'] = __('Could not remove the old version of the ');
        $this->strings['process_failed'] = __('Update failed.');
        $this->strings['process_success'] = __('Package updated successfully.');
        $this->strings['tf_backup'] = __('Backing up files&#8230;');
        $this->strings['tf_bk_mkdir_failed'] = __('Could not create backup directory.');
    }

    function bulk_footer() {
        $update_actions = array(
            'framework_page' => '<a href="' . self_admin_url('admin.php?page=themefuse') . '" title="' . esc_attr__('Go to framework page') . '" target="_parent">' . __('Return to Framework page') . '</a>',
        );
