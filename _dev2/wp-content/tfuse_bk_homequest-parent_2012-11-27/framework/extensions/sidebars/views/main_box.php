    ...
    <div class="widget-holder inactive">
        <div id="tf_sidebar_extra_settings">
            <div class="tf_meta_tabs">
                <ul>
                    <li>
                        <a href="#tfusetab-sidebar_new_settings">Add Sidebar</a>
                    </li>
                    <li>
                ...
                <div id="tfusetab-sidebar_new_settings">
                    ...
                    <div id="sidebar_action_buttons">
                        <a id="sidebars_add_sidebar" href="#" class="button">Add Sidebar</a>
                        <a id="sidebars_cancel_changes" href="#" class="button reset-button">Cancel Changes</a>
                    </div>
                    <!--end-->                        
                </div>
                <div id="tfusetab-sidebar_manage_settings">
                    ...
                    <table class="sdb_ph_table">
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a rel="<?php echo $rel; ?>" href="#" class="auto_select">Default for all</a>
                            </td>
                            <td>
                                <?php
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Posts</a>
                            </td>
                            <td>
                                <?php
                            ...
                            foreach ($settings['by_category_post'] as $id => $val) {
                                ...
                                <tr>
                                    <td class="padd-left" colspan="2">
                                        ...
                                        <a href="#" rel="<?php echo $rel; ?>" class="auto_select">By Category:</a> 
                                        <?php
                                        $ids = explode(',', $id);
                                        $out = '';
                                        foreach ($ids as $id) {
                            ...
                            foreach ($settings['by_id_post'] as $id => $val) {
                                ...
                                <tr>
                                    <td class="padd-left" colspan="2">
                                        ...
                                        ?>
                                        <img class="sidebar_settings_delete" rel="<?php echo $rel; ?>" src="<?php echo tf_extimage($this->ext->sidebars->_the_class_name, 'delete.png'); ?>" />
                                        <a href="#" rel="<?php echo $rel; ?>" class="auto_select">By Name:</a> 
                                        <?php
                                        $ids = explode(',', $id);
                                        $out = '';
                                        foreach ($ids as $id) {
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Pages</a>
                            </td>
                            <td>
                                <?php
                            ...
                            foreach ($settings['by_template_page'] as $id => $val) {
                                ...
                                <tr>
                                    <td class="padd-left" colspan="2">
                                        ...
                                        ?>
                                        <img class="sidebar_settings_delete" rel="<?php echo $rel; ?>" src="<?php echo tf_extimage($this->ext->sidebars->_the_class_name, 'delete.png'); ?>" />
                                        <a href="#" rel="<?php echo $rel; ?>" class="auto_select">By Page Template:</a> 
                                        <?php
                                        $ids = explode(',', $id);
                                ...
                                foreach ($settings['by_category_' . $key] as $id => $val) {
                                    ...
                                    <tr>
                                        <td class="padd-left" colspan="2">
                                            ...
                                            ?>
                                            <img class="sidebar_settings_delete" rel="<?php echo $rel; ?>" src="<?php echo tf_extimage($this->ext->sidebars->_the_class_name, 'delete.png'); ?>" />
                                            <a href="#" rel="<?php echo $rel; ?>" class="auto_select">By <?php echo ucfirst($taxonomy); ?>:</a> 
                                            <?php
                                            $ids = explode(',', $id);
                                            $out = '';
                                            foreach ($ids as $id) {
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Categories</a>
                            </td>
                            <td>
                                <?php
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Archive pages</a>
                            </td>
                            <td>
                                <?php
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Front page</a>
                            </td>
                            <td>
                                <?php
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Search page</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">Blog Page</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                ?>
                                <a href="#" rel="<?php echo $rel; ?>" class="auto_select">404 error page</a>
                            </td>
                            <td>
                    ...
                    <div class="explain_icons">
                        <img src="<?php echo tf_extimage($this->ext->sidebars->_the_class_name, 'sidebar_set.png'); ?>" /> Was set&nbsp;
                        <img src="<?php echo tf_extimage($this->ext->sidebars->_the_class_name, 'delete.png'); ?>" /> Remove settings&nbsp;
                        <img src="<?php echo tf_extimage($this->ext->sidebars->_the_class_name, 'sidebar_not_set.png'); ?>" /> Sidebar not set yet
                    </div>
