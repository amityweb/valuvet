...
jQuery(document).ready(function ($) {
    ...
    $('#tf_cf_form_setup').submit(function () {
        ...
        _inputs.each(function () {
            if (!$(this).closest('ul').hasClass('sortable_options') && $(this).attr('id') != 'tf_cf_email_from' && $(this).closest('.tf_custom_contactform_row').find('.medica_inp_select:last option:selected').val() != 6) {
                if ($.trim($(this).val()) == '') {
                ...
                _parent_select = $(this).closest('li .tf_custom_contactform_row').find('.medica_inp_select');
